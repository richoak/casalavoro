            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
                <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600" data-aos="fade-up" data-aos-delay="100">We follow a meticulous product management
                            process to create innovative solutions that address the specific needs of our users. From
                            ideation to launch, we prioritize user research, design thinking, and agile development to
                            build products that make a difference.</p>
                        <dl
                            class="mt-10 max-w-xl text-base leading-7 text-gray-600 lg:max-w-none md:flex space-y-3 lg:space-y-0 justify-between  gap-x-10">
                            <div class="relative">
                                <dt class="inline font-semibold text-gray-900" data-aos="fade-up" data-aos-delay="100">
                                    User-Focused
                                </dt>
                                <dd class="text-sm leading-6" data-aos="fade-up" data-aos-delay="100">We conduct extensive user research to gain deep insights
                                    into their
                                    pain points and preferences.</dd>
                            </div>
                            <div class="relative">
                                <dt class="inline font-semibold text-gray-900" data-aos="fade-up" data-aos-delay="100">
                                    Iterative Approach
                                </dt>
                                <dd class="text-sm leading-6" data-aos="fade-up" data-aos-delay="100">Our iterative approach allows us to continuously refine
                                    and improve
