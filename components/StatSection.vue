    ...
    <div class="relative bg-gray-900">
        ...
        <div
            ...
            <div class="relative pb-64 pt-12 sm:pb-64 sm:pt-24 xl:col-start-1 xl:pb-24">
                <h2 class="text-base font-semibold text-indigo-300">Innovate</h2>
                <p class="mt-3 text-3xl font-bold tracking-tight text-white">Empowering Businesses to Succeed in the
                    Digital Age</p>
                <p class="mt-5 text-lg text-gray-300">Buildr is a digital acceleration company that helps businesses
                ...
                <div class="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2">
                    <p>
                        ...
                        <span class="mt-1 block text-base text-gray-300">Successful
                                Projects Completed</span>
                    </p>
                    <p>
                        <span class="block text-2xl font-bold text-white">50%</span>
                        <span class="mt-1 block text-base text-gray-300">Client
                                Growth Rate</span>
                    </p>
                </div>
            </div>
