    ...
    <div class="relative isolate bg-white pb-32 pt-24 sm:pt-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-xl text-center">
                ...
                <p class="text-sm text-gray-600">Read testimonials from our satisfied clients</p>
            </div>
            <div
                ...
                <figure
                    ...
                    <blockquote
                        ...
                        <p>“Buildr is a game-changer in the digital industry.”</p>
                    </blockquote>
                    <figcaption
                ...
                <div class="space-y-8 xl:contents xl:space-y-0">
                    <div class="space-y-8 xl:row-span-2">
                        <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                            <blockquote class="text-gray-900">
                                <p>“Working with Buildr was a transformative experience.”</p>
                            </blockquote>
                    ...
                    <div class="space-y-8 xl:row-start-1">
                        <figure class="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                            <blockquote class="text-gray-900">
                                <p>“Buildr exceeded our expectations in every way.”</p>
                            </blockquote>
                            <figcaption class="mt-6 flex items-center gap-x-4">
                                <img class="h-10 w-10 rounded-full bg-gray-50"
