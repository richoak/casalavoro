            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
                <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Empowering
                            Businesses with Quality Assurance and Seamless User Experience
                        </p>
                        <p class="mt-6 text-lg leading-8 text-gray-600">We understand the importance of quality
