<template>
    <div class="bg-white">
        <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
            <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"  data-aos="fade-left">Accelerate Your Digital Growth Today
            </h2>
            <p class="text-sm font-medium text-gray-500 pt-3"  data-aos="fade-left">Unlock the full potential of your business with our
                digital
