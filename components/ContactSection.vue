        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48" data-aos="fade-left">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900" data-aos="fade-left">Get in touch</h2>
                    <p class="mt-6 text-lg leading-8 text-gray-600" data-aos="fade-left">We're here to answer any questions you may have or
                    ...
                    <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
                        ...
                        <div class="flex gap-x-4">
                            ...
                            <dd><a class="hover:text-gray-900" href="tel:+1 (555) 234-5678" data-aos="fade-left">+1 (555) 234-5678</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
            ...
            <form action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48" data-aos="fade-left">
