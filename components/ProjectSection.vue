    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            <div class="text-center">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white" data-aos="flip-left">Innovation in Action</h1>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 lg:grid-cols-2">
                <div>
                    ...
                    <div class="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                        <a href="#" class="font-semibold text-gray-800 hover:underline dark:text-white md:text-xl" data-aos="flip-left">
                ...
                <div>
                    ...
                    <div class="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
                        ...
                        <p class="mt-3 text-sm text-blue-500" data-aos="flip-left">20 October 2019</p>
                    </div>
                </div>
            </div>
        </div>
